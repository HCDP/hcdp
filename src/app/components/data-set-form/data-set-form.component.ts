...
export class DataSetFormComponent implements OnInit, AfterViewInit {
  private static readonly FORM_ORDER = ["historical_rainfall", "historical_temperature", "rh", "ndvi", "spi", "ignition_probability", "downscaled", "contemporary_climatology", "legacy_climatology"];
