...
export class ColorGeneratorService {
  ...
  getDomain(range: [number, number], domainTranslation: (value: number) => number): [number, number] {
    return [domainTranslation(range[0]), domainTranslation(range[1])];
  }

  getRange(range: [number, number], scaleTranslation: (value: number) => number): [number, number] {
    return [scaleTranslation(range[0]), scaleTranslation(range[1])];
  }


  getNWSRadarColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number): ColorScale {
    ...
    return new ColorScale(getColor, range, scaledRange, parts);
  }


  getDefaultRainbowRainfallColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
  ...
  getDefaultMonochromaticRainfallColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number): ColorScale {
  ...
  getColorSchemeFromAssetFile(xmlFile: string, range: [number, number], scaleTranslation: (value: number) => number, reverse: boolean = false): Promise<XMLColorSchemeData> {
    return this.http.get(xmlFile, { responseType: "text" }).toPromise().then((data: string) => {
      return this.getColorSchemeFromXML(data, range, scaleTranslation, reverse);
    });
  }

  getColorSchemeFromXML(xmlData: string, range: [number, number], scaleTranslation: (value: number) => number, reverse: boolean = false): Promise<XMLColorSchemeData> {
      ...
      parser.parseString(xmlData, (err, result) => {
        ...
        if(err) {
          ...
          try {
            ...
            colorScale = new ColorScale(getColor, range, scaledRange, parts);
          }
  ...
  getTurboColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
  ...
  getUSGSColorScale(range: [number, number], reverse: boolean, scaleTranslation: (value: number) => number): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
  ...
  getViridisColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
  ...
  getDivergentColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
  ...
  getIncreasingColorScale(range: [number, number], reverse: boolean, domainTranslation: (value: number) => number, scaleTranslation: (value: number) => number) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let scaledRange = this.getRange(range, scaleTranslation);
