...
export class ColorGeneratorService {
  ...
  getDomain(range: [number, number], usePseudoLog: boolean): [number, number] {
    return usePseudoLog ? [this.pseudoLog(range[0]), this.pseudoLog(range[1])] : range;
  }

  getNWSRadarColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean): ColorScale {
  ...
  getReverseRainbowColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
  ...
  getDefaultRainbowRainfallColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
  ...
  getDefaultMonochromaticRainfallColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean): ColorScale {
  ...
  getColorSchemeFromAssetFile(xmlFile: string, dataRange: [number, number], reverse: boolean = false): Promise<XMLColorSchemeData> {
  ...
  getTurboColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean): ColorScale {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
  ...
  getViridisColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
  ...
  getDivergentColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
  ...
  getIncreasingColorScale(dataRange: [number, number], reverse: boolean, usePseudoLog: boolean) {
    let parts = ColorGeneratorService.COLOR_PARTS;
    let range: [number, number] = dataRange;
